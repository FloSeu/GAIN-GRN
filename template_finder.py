...
def assign_indexing(gain_obj:object, file_prefix: str, gain_pdb: str, template_dir: str, hard_cut=None, debug=False, create_pdb=False, patch_gps=False):
    ...
    sdb_centers = { # REVISED S4-9,12 FOR CONS MATCH
                    'E5b':	{'S1':324, 'S2':333, 'S3':350, 'S4':359, 'S5':378, 'S6':409, 'S7':413, 'S8':430, 'S9':453, 'S10':459, 'S11':464, 'S12':478 ,'S13':487},
                    'G5b':	{'S1': 65, 'S2':74,  'S3':88 , 'S4':107 ,'S5':127,			 'S7':148 ,'S8':166 ,'S9':186 ,'S10':198 ,'S11':203 ,'S12':217 ,'S13':226}
                  }
    sdb_gps_res = { 
