...
if __name__ == '__main__':
    valid_collection = pd.read_pickle("../data/pkd_collection.pkl")
    ...
    stal_indexing.data2csv(header, matrix, "../data/pkd_indexing.csv")

    with open("../data/pkd_indexing.pkl","wb") as save:
